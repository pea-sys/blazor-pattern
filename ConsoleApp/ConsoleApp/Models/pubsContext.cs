...
public partial class pubsContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AuthorId).HasName("UPKCL_auidind");

            entity.ToTable("authors");

            entity.HasIndex(e => new { e.AuthorLastName, e.AuthorFastName }, "aunmind");
            ...
            entity.Property(e => e.AuthorFastName)
                .IsRequired()
                .HasMaxLength(20)
                .IsUnicode(false)
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__jobs__6E32B6A56C87A154");
